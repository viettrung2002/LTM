            ...
            <div class="content">
                <div class="product-title"
                   ...
                   <div class="product-more" >
	                    <a href="addSanPham.jsp" class="product-more-link">Tạo sản phẩm mới</a>
							...
							<div class="product c-3 col">
		                            ...
		                            <div class="product-bottom">
		                                <div class="product-bottom-price">
		                                    ...
		                                    <p class="product-price"><%=listDongHo.get(i).getGia()%>.000đ</p>
		                                </div>
		                                <div class="product-btn">
						...
						%>
							<div class="product c-3 col">
		                            ...
		                            <div class="product-bottom">
		                                <div class="product-bottom-price">
		                                    <p class="price-title">Giá</p>
		                                    <p class="product-price"><%=listLaptop.get(i).getGia()%>.000đ</p>
		                                </div>
		                                <div class="product-btn">
