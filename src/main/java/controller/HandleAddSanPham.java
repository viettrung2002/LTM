...
/**
 * Servlet implementation class HandleAddSanPham
 */
@WebServlet("/HandleAddSanPham")
public class HandleAddSanPham extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HandleAddSanPham() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			bo.addSanPham(MaSanPhamUpdate, TenSanPham, TheLoai, Gia, MoTa, Anh, "active");
